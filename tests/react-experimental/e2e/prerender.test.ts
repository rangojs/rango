...
test.describe("prerender handler (dev)", () => {
  ...
  test("should render parameterized prerender page", async ({ page }) => {
    ...
    await expect(testId(page, "prerender-article-title")).toHaveText(
      "Hello World",
    );
...
test.describe("prerender handler (production)", () => {
  ...
  test("should render parameterized prerender page on direct visit", async ({
    page,
  }) => {
    using _ = expectNoPageError(page);
  ...
  test("should have stable article timestamp across reloads", async ({
    page,
  }) => {
    using _ = expectNoPageError(page);
  ...
  test("should navigate to prerender page via client-side navigation", async ({
    page,
  }) => {
    using _ = expectNoPageError(page);
