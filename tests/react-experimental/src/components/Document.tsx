    ...
    <html lang="en" suppressHydrationWarning>
      ...
      <body>
        ...
        <nav data-testid="nav">
          ...
          <Link to={href("/prerender")} data-testid="nav-prerender">
            Prerender
          </Link>
          <Link to={href("/transition-a")} data-testid="nav-transition-a">
            Slide A
          </Link>
          <Link to={href("/transition-b")} data-testid="nav-transition-b">
            Slide B
          </Link>
          <Link to={href("/blog")} data-testid="nav-blog">
            Blog
          </Link>
          <Link to={href("/cards")} data-testid="nav-cards">
            Cards
          </Link>
        </nav>
        {children}
