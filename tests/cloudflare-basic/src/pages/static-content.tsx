  ...
  return (
    <div data-testid="static-docs-layout">
      <nav data-testid="static-docs-nav">
        ...
        <p
          data-testid="static-nav-build-time"
          style={{ fontSize: "0.75rem", color: "#999" }}
        >
          Nav built at: {BUILD_TIMESTAMP}
        </p>
        <p
          data-testid="static-nav-handler-time"
          style={{ fontSize: "0.75rem", color: "#999" }}
        >
...
export const DocsIndexPage = Static(async (ctx) => {
  ...
  return (
    <div data-testid="static-docs-index">
      ...
      <p
        data-testid="static-index-handler-time"
        style={{ fontSize: "0.75rem", color: "#999" }}
      >
...
export const DocsTocSidebar = Static(async () => {
  ...
  return (
    <aside data-testid="static-toc-sidebar">
      ...
      <p
        data-testid="static-toc-build-time"
        style={{ fontSize: "0.75rem", color: "#999" }}
      >
        TOC built at: {BUILD_TIMESTAMP}
      </p>
      <p
        data-testid="static-toc-handler-time"
        style={{ fontSize: "0.75rem", color: "#999" }}
      >
