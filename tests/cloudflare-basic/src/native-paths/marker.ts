...
// Static/Prerender handlers asserts the cloudflare discovery runner forwards the
// native tsconfigPaths flag into its temp server. Vite 8 supersedes
// vite-tsconfig-paths with this built-in flag; see utils/forward-user-plugins.ts.
