 ...
 */
devTest.describe("scroll-restoration", () => {
  devTest(
    "should scroll to top on forward navigation",
  ...
  devTest(
    "should restore scroll position on back navigation",
    async ({ page, devServerURL }) => {
      using _ = expectNoPageError(page);
  ...
  devTest(
    "should handle scroll restoration across multiple navigations",
    async ({ page, devServerURL }) => {
      using _ = expectNoPageError(page);
...
// ---------- PRODUCTION ----------
test.describe("scroll-restoration (production)", () => {
