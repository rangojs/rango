...
export const CartRoute: Handler<"/cart"> = (ctx) => {
  ctx.use(Meta)({ title: "Cart" });
  return (
      ...
      <div style={{ display: "flex", gap: "2rem" }}>
        <div style={{ flex: 1 }}>
          ...
          >
            ...
            <p>
              This route uses <code>[revalidate("cart")]</code> to ALWAYS
              refresh cart data.
            </p>
            <p>
              Try navigating away and back - you'll see the segment re-renders.
            </p>
