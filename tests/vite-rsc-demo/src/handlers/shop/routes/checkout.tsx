  ...
  <div style={{ display: "flex", gap: "2rem" }}>
    <div style={{ flex: 1 }}>
      ...
      >
        ...
        <p>
          This route uses{" "}
          <code>[middleware("checkout.index", "requireAuth")]</code>
        </p>
...
export const CheckoutPaymentRoute: Handler<"/checkout/payment"> = () => (
  <div style={{ display: "flex", gap: "2rem" }}>
    <div style={{ flex: 1 }}>
      <h2>Payment</h2>
...
export const CheckoutConfirmRoute: Handler<"/checkout/confirm"> = () => (
  <div>
    <div
      style={{
        background: "#d1f2eb",
