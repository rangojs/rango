...
export const AccountOrdersRoute: Handler<"/account/orders"> = () => (
  <div>
    ...
    >
      ...
      <p>
        This route uses{" "}
        <code>[middleware("shop.account.orders", "permissions")]</code>
      </p>
      <SegmentTimer serverRenderTime={new Date().toISOString()} />
    </div>
  </div>
...
export const AccountOrderDetailRoute: Handler<"/account/orders/:id"> = (
  ctx,
) => {
  ...
  return (
    <div>
      ...
      >
        ...
        <p>
          This route uses <code>[revalidate("shop.account.orderDetail")]</code>
        </p>
        <p>
