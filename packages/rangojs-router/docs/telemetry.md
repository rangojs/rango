...
| `ppr:shell-read`                                                                                                   | PPR        | PPR shell store read; description is `hit` or `miss` (the raw store outcome, before validity gates such as a version mismatch)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `ppr:capture` / `ppr:tail`                                                                                         | PPR        | Dev only. The previous shell capture's outcome (`ppr:capture`) and the previous shell HIT's tail timing (`ppr:tail`, duration = complete ms). Both finish after their own response commits, so they ride the NEXT request's `Server-Timing`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
