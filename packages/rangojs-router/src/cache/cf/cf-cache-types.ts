...
// ============================================================================
//
// Public types extracted from cf-cache-store.ts. Re-exported from
// cf-cache-store.ts (and onward through cf/index.ts) so the import path is
// preserved. These are interface/type declarations only; no runtime dependency
// on the CFCacheStore class.
