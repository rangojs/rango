...
// ============================================================================
// Constants (moved to ./cf-cache-constants.js)
// ============================================================================
//
// Public constants are re-exported below to preserve the import path; the
// private ones (CACHE_EXPIRES_AT_HEADER / CACHE_ORIG_CC_HEADER /
// TAG_MARKER_CACHE_PREFIX / TAG_MARKER_ABSENT) are imported for internal use.
...
// Re-export the public constants from the same path consumers/tests import.
export {
  CACHE_STALE_AT_HEADER,
  CACHE_STATUS_HEADER,
  CACHE_TAGS_HEADER,
...
// tagMarkerMemo / tagMarkerInflight + their getters moved to
// ./cf-tag-marker-memo.js (the WeakMaps stay module singletons there).
...
// KV_MAX_KEY_BYTES / KV_MIN_EXPIRATION_TTL / kvKeyByteLength (+ its encoder) and
// remainingCacheControl moved to ./cf-kv-utils.js.
...
// EDGE_LOOKUP_TIMEOUT_MS / EDGE_READ_TIMEOUT_MS / KV_READ_TIMEOUT_MS are imported
// and re-exported from ./cf-cache-constants.js at the top of this file.

// ============================================================================
// Types (moved to ./cf-cache-types.js)
// ============================================================================
//
// KVNamespace / CFCacheReadDebugEvent / CFCacheDebug / CFCacheStoreOptions are
// re-exported below to preserve the import path.
...
// bufferToBase64 / base64ToBuffer moved to ./cf-base64.js.
