...
// ============================================================================
// ResponseHandlerContext — env passthrough, searchParams, url, pathname
// ============================================================================

type TestBindings = { DB: "d1"; KV: "kv" };

describe("ResponseHandlerContext", () => {
  it("should pass through env directly (no extraction)", () => {
    type Ctx = ResponseHandlerContext<{}, TestBindings>;
    expectTypeOf<Ctx["env"]>().toEqualTypeOf<{ DB: "d1"; KV: "kv" }>();
  });

  it("should pass through any env shape directly", () => {
