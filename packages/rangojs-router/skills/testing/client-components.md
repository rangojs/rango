...
| `defaultPrefetch` | `PrefetchStrategy`                                                     | Instance-scoped router default. Mirrors `createRouter({ defaultPrefetch })` for `<Link>` and plain anchors unless they set `data-prefetch="false"`.                                                                  |
