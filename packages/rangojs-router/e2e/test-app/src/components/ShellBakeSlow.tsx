...
export function ShellBakeSlow({
  bakeLoader,
  holeLoader,
}: {
  bakeLoader: LoaderDefinition<{ label: string }>;
  holeLoader: LoaderDefinition<ShellPriceData>;
}) {
  ...
  return (
    <>
      <span data-testid="shell-bake-label">{bake.label}</span>
      <div data-testid="shell-bake-price" data-seq={seq}>
