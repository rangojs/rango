...
import type { ShellExecCounters } from "../urls/shell-cache.defs.js";
...
export function ShellExecMatrix({
  loader,
}: {
  loader: LoaderDefinition<ShellExecCounters>;
}) {
  const { data } = useLoader(loader);
  return <div data-testid="shell-exec-counters">{JSON.stringify(data)}</div>;
}
