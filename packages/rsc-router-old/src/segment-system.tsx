...
export interface Segment {
  ...
  /**
   * Backward compatibility: true for layouts
   */
  isLayout?: boolean;
 ...
 * to handle layout nesting. The function wraps each component with OutletProvider,
...
export function renderSegments(segments: ResolvedSegment[]): ReactNode {
  ...
  for (let i = segments.length - 1; i >= 0; i--) {
    const { component, ...meta } = segments[i]!;
    //TODO: fix this error
    content = createElement(OutletProvider, { content, ...meta }, component);
  }
