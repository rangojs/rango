...
test.describe("location-state", () => {
  ...
  test("should show location state in loading state when navigating with state", async ({ page }) => {
    using _ = expectNoPageError(page);
    ...
    try {
      ...
      await expect(loadingDescription).toHaveText("React components that render on the server");
    } catch {
  ...
  test("should show skeleton in loading state when navigating without state", async ({ page }) => {
    using _ = expectNoPageError(page);
  ...
  test("should navigate to different features with correct state", async ({ page }) => {
    using _ = expectNoPageError(page);
  ...
  test("should preserve location state across browser history", async ({ page }) => {
    using _ = expectNoPageError(page);
  ...
  test("should not show hydration mismatch with location state", async ({ page }) => {
