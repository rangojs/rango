...
test.describe("content negotiation (dev)", () => {
  ...
  test("Accept: application/json returns JSON envelope", async ({ request }) => {
    const response = await request.get(f.url("/test/negotiate"), {
  ...
  test("no Accept header returns JSON (negotiate handler)", async ({ request }) => {
  ...
  test("Accept: */* returns JSON (no explicit text/html)", async ({ request }) => {
    const response = await request.get(f.url("/test/negotiate"), {
      headers: { Accept: "*/*" },
    });
    expect(response.status()).toBe(200);
  ...
  test("Vary: Accept present on negotiated JSON response", async ({ request }) => {
    const response = await request.get(f.url("/test/negotiate"), {
      headers: { Accept: "application/json" },
    });
  ...
  test("Vary: Accept present on HTML response from negotiated URL", async ({ request }) => {
    const response = await request.get(f.url("/test/negotiate"), {
      headers: { Accept: "text/html,application/xhtml+xml" },
    });
    const vary = response.headers()["vary"] || "";
  ...
  test("text negotiate: no text/html returns plain text", async ({ request }) => {
    const response = await request.get(f.url("/test/negotiate-text"), {
  ...
  test("multi negotiate: application/json returns JSON", async ({ request }) => {
    const response = await request.get(f.url("/test/negotiate-multi"), {
      headers: { Accept: "application/json" },
    });
    expect(response.status()).toBe(200);
  ...
  test("multi negotiate: */* returns first variant (json)", async ({ request }) => {
    const response = await request.get(f.url("/test/negotiate-multi"), {
      headers: { Accept: "*/*" },
    });
    expect(response.status()).toBe(200);
  ...
  test("wildcard negotiate: text/html returns HTML", async ({ request }) => {
    const response = await request.get(f.url("/test/negotiate-wild/some/path"), {
      headers: { Accept: "text/html,application/xhtml+xml" },
    });
    expect(response.status()).toBe(200);
    const contentType = response.headers()["content-type"] || "";
  ...
  test("wildcard negotiate: application/json returns JSON with wildcard param", async ({ request }) => {
    const response = await request.get(f.url("/test/negotiate-wild/some/path"), {
      headers: { Accept: "application/json" },
    });
    expect(response.status()).toBe(200);
  ...
  test("multi negotiate: Vary: Accept on all negotiated responses", async ({ request }) => {
...
test.describe("content negotiation (build)", () => {
  ...
  test("Accept: application/json returns JSON envelope in production", async ({ request }) => {
    const response = await request.get(f.url("/test/negotiate"), {
      headers: { Accept: "application/json" },
    });
    expect(response.status()).toBe(200);
  ...
  test("Vary: Accept present on negotiated response in production", async ({ request }) => {
    const response = await request.get(f.url("/test/negotiate"), {
      headers: { Accept: "application/json" },
    });
    const vary = response.headers()["vary"] || "";
  ...
  test("wildcard negotiate: JSON in production", async ({ request }) => {
    const response = await request.get(f.url("/test/negotiate-wild/deep/path"), {
      headers: { Accept: "application/json" },
    });
    expect(response.status()).toBe(200);
    expect(response.headers()["content-type"]).toContain("application/json");
