...
/**
 * Blog Layout - wraps all blog pages with sidebar
 */
function BlogLayout() {
  return (
...
/**
 * Sidebar component - shows recent posts and tags
 */
...
/**
 * Sidebar skeleton shown during streaming
 */
...
export default map<typeof blogRoutes>(
  ({ route, cache, layout, parallel, loader, loading }) => [
    // Blog layout with sidebar - breadcrumbs set at layout level
    layout(
      (ctx) => {
        // Push common breadcrumbs at layout level (only once)
      ...
      () => [
        // Parallel sidebar with streaming (has its own loader)
        parallel(
          {
            "@sidebar": async (ctx) => {
        ...
        cache({ ttl: 60, swr: 300 }, () => [
          ...
          route("index", (ctx) => {
            ...
            // Read posts directly - static data gets cached with RSC output
            ...
            return (
              <div data-testid="blog-index">
                ...
                <p style={{ color: "#666", marginBottom: "2rem" }}>
                  Articles about RSC, Cloudflare Workers, and modern web
                  development.
                </p>
