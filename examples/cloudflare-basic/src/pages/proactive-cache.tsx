  ...
  return (
    <div data-testid="proactive-cache-layout">
      ...
      <nav data-testid="proactive-nav">
        <Link to={href("home")} data-testid="proactive-back-home">
          Home
        </Link>
        {" | "}
        <Link to={href("proactiveCache")} data-testid="proactive-nav-index">
          Index
        </Link>
        {" | "}
        <Link to={href("proactiveCacheItemA")} data-testid="proactive-nav-a">
          Item A
        </Link>
        {" | "}
        <Link to={href("proactiveCacheItemB")} data-testid="proactive-nav-b">
          Item B
        </Link>
      </nav>
      <Outlet />
