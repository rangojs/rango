...
export function ArticleStatsSidebar() {
  ...
  return (
    <div data-testid="articles-stats-sidebar" style={{ padding: "1rem", background: "#f9f9f9", borderRadius: "8px" }}>
      <h3 style={{ marginBottom: "0.5rem", fontSize: "1rem" }}>Article Stats</h3>
      <p data-testid="stats-rendered-at" style={{ fontSize: "0.875rem", color: "#666" }}>
