  ...
  return (
    <div style={{ maxWidth: "800px", margin: "0 auto", padding: "2rem" }}>
      ...
      <ul style={{ marginBottom: "2rem", lineHeight: "1.8" }}>
        ...
        <li><strong>~200 shop routes</strong> — nested includes demo:
          <ul style={{ marginTop: "0.5rem" }}>
            <li><code>/shop/product/*</code> — 102 routes (staticPrefix: "/shop/product")</li>
            <li><code>/shop/category/*</code> — 102 routes (staticPrefix: "/shop/category")</li>
          </ul>
        </li>
      </ul>
      ...
      <div style={{
        ...
        <ul style={{ margin: "0.5rem 0 0 1rem", padding: 0 }}>
          ...
          <li>Shop product routes skip shop category routes (nested optimization!)</li>
      ...
      <p style={{ color: "#666", marginBottom: "1rem" }}>
        <code>/shop</code> contains nested <code>include("/product", ...)</code> and{" "}
        <code>include("/category", ...)</code>. Each gets its own <code>staticPrefix</code>,
        so they skip each other during matching.
      </p>
      ...
      <div style={{
        ...
        <strong>Key insight:</strong> <code>/shop/product/*</code> has staticPrefix{" "}
        <code>"/shop/product"</code>, while <code>/shop/category/*</code> has{" "}
        <code>"/shop/category"</code>. They are different, so the optimization works!
      </div>
      ...
      <p style={{ color: "#666", marginBottom: "1rem", fontSize: "0.9rem" }}>
        Check <code>matchStats.entriesSkipped</code> in JSON response to see optimization in action.
      </p>
      <table style={{ width: "100%", borderCollapse: "collapse", marginTop: "1rem" }}>
        <thead>
          <tr style={{ background: "#f5f5f5" }}>
            <th style={{ padding: "0.5rem", textAlign: "left", borderBottom: "2px solid #ddd" }}>Route</th>
            <th style={{ padding: "0.5rem", textAlign: "left", borderBottom: "2px solid #ddd" }}>Skips</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td style={{ padding: "0.5rem", borderBottom: "1px solid #eee" }}><code>/bench/first</code></td>
            <td style={{ padding: "0.5rem", borderBottom: "1px solid #eee" }}>Nothing (root)</td>
          </tr>
          <tr>
            <td style={{ padding: "0.5rem", borderBottom: "1px solid #eee" }}><code>/api/bench/*</code></td>
            <td style={{ padding: "0.5rem", borderBottom: "1px solid #eee", color: "#2e7d32", fontWeight: "bold" }}>
              /site (5k), /shop/* (200+)
            </td>
          </tr>
          <tr>
            <td style={{ padding: "0.5rem", borderBottom: "1px solid #eee" }}><code>/site/en/bench/*</code></td>
            <td style={{ padding: "0.5rem", borderBottom: "1px solid #eee" }}>Nothing (matched before /api, /shop)</td>
          </tr>
          <tr style={{ background: "#fff8e1" }}>
            <td style={{ padding: "0.5rem", borderBottom: "1px solid #eee" }}><code>/shop/product/*</code></td>
            <td style={{ padding: "0.5rem", borderBottom: "1px solid #eee", color: "#e65100", fontWeight: "bold" }}>
              /site (5k), /api (5k), /shop/category (102)
            </td>
          </tr>
          <tr style={{ background: "#fff8e1" }}>
            <td style={{ padding: "0.5rem", borderBottom: "1px solid #eee" }}><code>/shop/category/*</code></td>
            <td style={{ padding: "0.5rem", borderBottom: "1px solid #eee", color: "#e65100", fontWeight: "bold" }}>
