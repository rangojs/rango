...
export const ARTICLES: Article[] = [
  {
    ...
    date: "Mar 15, 2025",
    excerpt: "Deploy server components at the edge for instant global response times.",
  ...
  },
  {
    ...
    content: "Type-safe routes generate TypeScript types from your route definitions. The href() helper validates route names and parameters at compile time, catching broken links before they reach production. When you rename a route or change its parameters, the compiler flags every reference that needs updating.",
  ...
  },
  {
    ...
    title: "Hello World",
    date: "Nov 1, 2024",
    excerpt: "A minimal example demonstrating the basics of pre-rendered routes.",
