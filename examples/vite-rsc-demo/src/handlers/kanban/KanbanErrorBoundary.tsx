...
import { ErrorBoundary, useClientCache, useNavigation } from "@rangojs/router/client";
...
function KanbanClientErrorFallback({ error, reset }: ClientErrorBoundaryFallbackProps) {
