...
export default map<typeof shopRoutes>({
  ...
  [revalidate("account.orderDetail")]: ({
    currentParams,
    nextParams,
    defaultShouldRevalidate,
  }) => {
    ...
    return (
      <div>
        ...
        >
          ...
          >
            ↑ Frozen from <code>ctx.searchParams</code>. Won't update if segment
            not revalidated!
          </p>
        </div>
    ...
    <div style={{ display: "flex", gap: "2rem" }}>
      <div style={{ flex: 1 }}>
        ...
        >
          ...
          >
            <a href="/shop" style={{ color: "#0066cc" }}>
              ← Continue Shopping
            </a>
            <a
              href="/shop/checkout"
  ...
  "checkout.confirm": () => (
    <div>
      ...
      >
        <h2 style={{ margin: "0 0 1rem 0", color: "#0f5132" }}>
          ✓ Order Confirmed!
        </h2>
        <p className="segment-id">Segment: Checkout Confirm</p>
        <p>Your order has been successfully placed.</p>
        <p
          style={{ fontWeight: "bold", fontSize: "1.25rem", margin: "1rem 0" }}
        >
          Order #ORD-004
        </p>
        <div
    ...
    return (
      <div>
        ...
        >
          ...
          >
            ↑ This user object was added to <code>ctx.user</code> by the
            "mockAuth" middleware
          </p>
        </div>
