...
export function CurrentURL() {
  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: '0.5rem', fontSize: '0.85rem', fontWeight: 'bold', color: '#0066cc' }}>
        🌐 CURRENT Browser URL (Client Component)
      </div>
      <div style={{ fontSize: '0.8rem', marginBottom: '0.25rem' }}>
        <strong>Full URL:</strong> <code style={{ fontSize: '0.75rem' }}>{url}</code>
      </div>
      ...
      <p style={{ fontSize: '0.7rem', color: '#0066cc', marginTop: '0.5rem', marginBottom: 0, fontStyle: 'italic' }}>
