...
devTest.describe("magazine-navigation", () => {
  ...
  devTest("should display author posts page", async ({ page, devServerURL }) => {
    using _ = expectNoPageError(page);
...
devTest.describe("magazine-breadcrumbs", () => {
  devTest("should display Magazine breadcrumb on index", async ({ page, devServerURL }) => {
    using _ = expectNoPageError(page);
  ...
  devTest("should display article breadcrumbs", async ({ page, devServerURL }) => {
    using _ = expectNoPageError(page);
  ...
  devTest("should display author breadcrumbs", async ({ page, devServerURL }) => {
    using _ = expectNoPageError(page);
  ...
  devTest("should display author posts breadcrumbs", async ({ page, devServerURL }) => {
    using _ = expectNoPageError(page);
  ...
  devTest("should handle SPA navigation with breadcrumb updates", async ({
    page,
    devServerURL,
  }) => {
    using _ = expectNoPageError(page);
  ...
  devTest("should preserve breadcrumbs on back navigation", async ({
    page,
    devServerURL,
  }) => {
    using _ = expectNoPageError(page);
...
test.describe("magazine-navigation (production)", () => {
  ...
  test("should handle SPA navigation with breadcrumb updates in production", async ({ page }) => {
    using _ = expectNoPageError(page);
    const breadcrumbNav = page.locator('nav[aria-label="Breadcrumb"]');
  ...
  test("should preserve breadcrumbs on back navigation in production", async ({ page }) => {
    using _ = expectNoPageError(page);
    const breadcrumbNav = page.locator('nav[aria-label="Breadcrumb"]');
