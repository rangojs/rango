...
Vercel Shop is a Rango storefront template for Shopify, built from the ground up for agentic development.
...
- **Cache directives** (`"use cache"`) for instant static responses with dynamic parts streamed in
