...
Once you're comfortable with the [agent workflow](/docs/shop-template/getting-started/extending-with-agents), use these patterns to tackle common storefront customizations.
