...
| Scope                                | Required by                                                           |
| ------------------------------------ | --------------------------------------------------------------------- |
| `unauthenticated_read_customer_tags` | [Enable Shopify Auth](/docs/shop-template/skills/enable-shopify-auth) |
| `unauthenticated_read_metaobjects`   | [Enable Shopify CMS](/docs/shop-template/skills/enable-shopify-cms)   |

## Related docs

<Cards>
  <Card title="Getting Started" href="/docs/shop-template/getting-started">
  ...
  >
    Required and optional environment variables for local development and
    deploys.
  </Card>
  <Card
