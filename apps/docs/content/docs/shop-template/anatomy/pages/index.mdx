...
<Cards>
  <Card title="Home" href="/docs/shop-template/anatomy/pages/home">
    The storefront landing page - hero, featured collections, and promotional
    content.
  </Card>
  <Card
    title="Product Detail Page (PDP)"
    href="/docs/shop-template/anatomy/pages/pdp"
  >
    Individual product pages with variants, media, and add-to-cart.
  </Card>
  <Card
    title="Product Listing Page (PLP)"
    href="/docs/shop-template/anatomy/pages/plp"
  >
